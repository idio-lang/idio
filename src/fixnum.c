...
{
    idio_module_set_symbol_value (IDIO_SYMBOL ("FIXNUM-MAX"), idio_fixnum (IDIO_FIXNUM_MAX), idio_Idio_module);
    idio_module_set_symbol_value (IDIO_SYMBOL ("FIXNUM-MIN"), idio_fixnum (IDIO_FIXNUM_MIN), idio_Idio_module);
