...
IDIO idio_character_module = idio_S_nil;
...
{
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_p);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char2integer);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_alphabetic_p);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_numeric_p);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_downcase);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_lower_case_p);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_upcase);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_upper_case_p);
    IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_whitespace_p);

    /*
     * The char_* functions were autogenerated but we still need to
     * add the sigstr and docstr
     */
    IDIO fvi = IDIO_EXPORT_MODULE_PRIMITIVE (idio_character_module, char_le_p);
...
void idio_init_character ()
{
    ...
    idio_character_module = idio_module (IDIO_SYMBOLS_C_INTERN ("character"));
