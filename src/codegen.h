...
typedef enum {
    ...
    IDIO_I_CODE_IPRIMCALL0,
    IDIO_I_CODE_PRIMCALL1,
    IDIO_I_CODE_IPRIMCALL1,
    IDIO_I_CODE_PRIMCALL2,
    IDIO_I_CODE_IPRIMCALL2,
...
#define IDIO_I_IPRIMCALL0               ((const IDIO) IDIO_CONSTANT_I_CODE (IDIO_I_CODE_IPRIMCALL0))
#define IDIO_I_PRIMCALL1                ((const IDIO) IDIO_CONSTANT_I_CODE (IDIO_I_CODE_PRIMCALL1))
#define IDIO_I_IPRIMCALL1               ((const IDIO) IDIO_CONSTANT_I_CODE (IDIO_I_CODE_IPRIMCALL1))
#define IDIO_I_PRIMCALL2                ((const IDIO) IDIO_CONSTANT_I_CODE (IDIO_I_CODE_PRIMCALL2))
#define IDIO_I_IPRIMCALL2               ((const IDIO) IDIO_CONSTANT_I_CODE (IDIO_I_CODE_IPRIMCALL2))
