...
IDIO idio_reopen_input_string_handle_C (IDIO sh, char const *str, size_t blen);
IDIO idio_open_input_string_handle_C (char const *str, size_t blen);
...
ptrdiff_t idio_puts_string_handle (IDIO sh, char const *s, size_t slen);
